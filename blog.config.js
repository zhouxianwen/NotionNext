...
AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xianwen', // 您的昵称 例如 techxianwen
BIO: process.env.NEXT_PUBLIC_BIO || 'xianwen的个人网站', // 作者简介
LINK: process.env.NEXT_PUBLIC_LINK || 'https://techxianwen.xyz', // 网站地址
